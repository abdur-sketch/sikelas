  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        <header className="topbar"><button className="menu-button" onClick={() => setMenuOpen(true)} aria-label="Buka menu">☰</button><div className="topbar-spacer" /><label className="top-search"><span>⌕</span><input placeholder="Cari siswa, tugas, atau materi..." /></label><div className="notification-wrap"><button className="notification-button" onClick={() => setNotifications(!notifications)} aria-label="Notifikasi">♢<i /></button>{notifications && <div className="notification-popover"><strong>Notifikasi</strong><p>3 tugas menunggu penilaian.</p><p>Absensi hari ini belum dikunci.</p></div>}</div><button className="help-button">?</button></header>
